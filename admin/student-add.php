...
if (
  ...
  if ($_SESSION['role'] == 'Admin') {
    ...
    if (isset($_GET['roll_no'])) $roll_no = $_GET['roll_no'];
?>
    <!DOCTYPE html>
    <html lang="en">
      ...
      <div class="student-add-card">
        <div class="school-header">
          ...
          <div>
            ...
            <div style="font-size:1.1rem;color:#555;">Add New Student</div>
          </div>
        </div>
        ...
        <form method="post" action="req/student-add.php">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" value="<?= $roll_no ?>" name="roll_no" required>
          </div>
          <div class="mb-3">
